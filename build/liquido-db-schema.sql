...
create table laws (id bigint not null, created_at timestamp not null, updated_at timestamp not null, description varchar(1000) not null, icon varchar(255), reached_quorum_at timestamp, status integer not null, title varchar(255) not null, area_id bigint not null, created_by_id bigint, poll_id bigint, primary key (id))
