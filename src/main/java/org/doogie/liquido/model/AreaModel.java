...
public class AreaModel extends BaseModel {
  ...
  /* This way one could inline createdBy user information as "creator" field.  But this would unconditionally ALWAYS inline that information, e.g. also as proposal.area.creator in list of laws which I do not want
