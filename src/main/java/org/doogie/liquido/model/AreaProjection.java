...
//If you want to always inline a field or value (in any search or get request, then you can creaete a getter in the model.
...
public interface AreaProjection {
  ...
  Date getCreatedAt();
  Date getUpdatedAt();
  UserModel getCreatedBy();    // this will inline the creator information into the result
}
